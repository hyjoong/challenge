...
const GameWrapper = () => {
  ...
  const [lottoList, setLottoList] = useState(defaultLottoNumbers);
  ...
  const regexWord = useCallback((wordInput: string) => {
  ...
  const handleMakeLottos = useCallback(() => {
    const lottos = [];
